...
function render(screen, token, username, firstName, lastName) {
    ...
    if('mobileLogin' == screen){        
        ...
        '        <p class="lead" style="margin:5px;"><a href="#" border="0"><img src="img/logo_appstore.jpg" width="100" height="37" style="margin-right:5px;"/></a><i>Bientôt disponible</i></p>\n' +
        '        <p class="lead" style="margin:5px;"><a href="#" border="0"><img src="img/logo_andoid.png" width="100" height="37" style="margin-right:5px;"/></a><i>Bienôt disponible</i></p>\n' +        
        '                              \n' +        
        '         \n'      
